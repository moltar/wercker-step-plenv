...
export PLENV_INSTALL_ARGS="$WERCKER_PLENV_VERSION $WERCKER_PLENV_SWITCHES"
export PLENV_VERSION_DIR="$WERCKER_PLENV_VERSION"
...
debug "dir: $PLENV_ROOT/versions/$PLENV_VERSION_DIR"
ls -lA $PLENV_ROOT/versions/$PLENV_VERSION_DIR
